...
#     print('The Users name is {last_name}')
#     if work:
...
# printParams(1,2,3) # позиционные
# # printParams(b=2, a=1, c=3) # именованные
#
# оператор *
...
#     import string as s 
#     import random
#     random_str = ''.join(random.choice(s.ascii_letters + s.digits) for i in range(0,len))
#     return random_str
...
#     else: return 'Вы ввели неверное оператор'
