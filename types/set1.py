# Множество в пайтоне - "контейнер", который содержит 
# в себе уникальные элементы в не упорядоченном виде
...
# frozenset(неизменяемые тип данных)
...
# Важно учесть, что пользователи могут ввести любой тип данных в качестве аргумента (не попадитесь на этом и 
