# Даны две переменные s1 = "America" и s2 = "Japan".  
# Выведите новую строку в который будут записаны первый, средний и 
# последний элемент двух переменных.  Необходимо использовать срезы.
# # Вывод: "AJrpan".
# s1 = "America"
# s2 = "Japan"
